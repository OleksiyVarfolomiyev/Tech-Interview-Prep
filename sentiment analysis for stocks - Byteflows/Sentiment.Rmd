...
We have presented a word count approach towards sentiment analysis. In the first part positive and negative words are added up for an overall sense of the sentiment. In the second part we deal we negation and recalculate our score to correct for negation. In future works we will updating the `lexicon` to consider newer and more up to date terminalogy about the stock market. 
